...
public class minerArmor extends ItemArmor
{
    String itemTexture;
    String armorTexture;

    public minerArmor(int id, EnumArmorMaterial material, int renderIndex, int slotType, String itemTexture, String armorTexture)
    {
