...
public class opalArmor extends ItemArmor
{
    String itemTexture;
    String armorTexture;

    public opalArmor(int id, EnumArmorMaterial material, int renderIndex, int slotType, String itemTexture, String armorTexture)
    {
